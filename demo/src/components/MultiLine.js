...
function MultiLine(props) {
  ...
  useEffect(() => {
    ...
    .text("Arrived");
        ...
        <div>
        <div className ="title">
            <h3>MultiLine Graphs</h3>
            <p><span style={{color: "yellow"}}>Covid: </span> Shows change in covid19 cases over period</p>
            <p><span style={{color: "red"}}> Departed: </span> Shows change in departed flights over period </p>
            <p><span style={{color: "blue"}}> Arrived: </span> Shows change in arrived flights over period</p>
