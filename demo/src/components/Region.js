...
import TransitionBarChart from "./TransitionBarCharts";
...
class  Region extends React.Component {
  ...
  <Row>
    ...
    <p id="detailsArcDiagram">Details(hover over the nodes)</p>
    </Row>
    <Row className="justify-content-md-center">
    <TransitionBarChart month={this.state.month} />
    </Row>
    </Col>
    <Col>
    <Row className="justify-content-md-center"> <DropdownButton
      ...
      <Row id="regionTravelSummary" className="justify-content-md-center">
